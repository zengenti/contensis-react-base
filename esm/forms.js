...
const makeSelectPagedFields = formId => createSelector([selectForms], form => {
  if (form[formId]) {
...
export { actions, Form as default, reducer, formV2Sagas as sagas, selectors };
