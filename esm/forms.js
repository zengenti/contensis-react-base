    ...
    case SET_DEFAULT_FIELD_VALUE:
      {
        ...
        state[formId].data = { ...state[formId].data,
          ...value
        };
        return;
      }
...
>>>>>>> master
  ...
  try {
    ...
    const regexObject = new RegExp(regexPattern.replace(/^\/|\/$/g, '')); // Check the value being tested
...
const sagas = [takeEvery(SUBMIT_FORM_SUCCESS, onFormSuccess), takeEvery(SUBMIT_FORM_FOR_VALIDATION, doValidateForm), takeEvery(SUBMIT_FORM, onSubmitForm), takeEvery(SET_FORM_ID, doFetchForm), // takeLatest(VALIDATE_FIELD, onValidateField),
...
function* setDefaultValueFields(action) {
  ...
  const entryId = yield select(selectors$1.selectRouteEntryEntryId);
  let fieldObj = {};
  fields.forEach(field => {
...
const Textfield = ({
  ...
  const [_, setTextfieldValue] = useState(defaultValueText || '');
  ...
  }), hasCharLimit && /*#__PURE__*/React.createElement(CharacterLimit, {
    value: defaultValue,
  ...
  }))), instructions && /*#__PURE__*/React.createElement(MarkdownRenderer, {
...
const Textarea = ({
  ...
  const [a11yInvalid, setA11yInvalid] = useState('');
  const [_, setTextareaValue] = useState(defaultValueText || '');
  const selectFormValidationSent = makeSelectFormValidationSent(formId);
  const formValidationSent = useSelector(selectFormValidationSent);
  useEffect(() => {
    if (formValidationSent) setA11yInvalid(doA11yValidation(_, field, true));
...
function requireDist () {
	...
	(function (module, exports) {
		!function (t, e) {
		  module.exports = e() ;
		}("undefined" != typeof self ? self : dist, function () {
		  return function (t) {
		    var e = {};
		    function n(r) {
		      if (e[r]) return e[r].exports;
      ...
      case 'content':
        {
          ...
          }, name === null || name === void 0 ? void 0 : name[defaultLanguage]), instructions && /*#__PURE__*/React.createElement(MarkdownRenderer, {
...
var ButtonStyled = styled.button.withConfig({
  ...
  return css(["", ""], useDefaultTheme && css(["display:inline-flex;align-items:center;justify-content:center;cursor:pointer;margin:16px 0 0 0;padding:8px 16px;border-radius:3px;border:1px solid ", ";font-family:inherit;transition:opacity 200ms ease;&:disabled{opacity:0.7;cursor:not-allowed;border-color:", ";background:", ";color:", ";svg{margin-left:4px;circle{stroke:", ";}}}&:hover{opacity:0.7;}"], theme.colors.border, theme.colors.light_grey_light, theme.colors.light_grey_light, theme.colors.light_grey_dark, theme.colors.light_grey_dark));
});
...
const Button = ({
  ...
  return /*#__PURE__*/React.createElement(ButtonStyled, {
    ...
    disabled: loading,
    useDefaultTheme: useDefaultTheme
  }, text, loading && /*#__PURE__*/React.createElement(Loader, {
    height: 18,
    width: 18
  }));
};
...
var CalloutStyled = styled.div.withConfig({
  displayName: "calloutstyled",
  componentId: "sc-k461qh-0"
})(["", ";"], ({
  theme
}) => {
  return css(["background:#F1F6FD;box-shadow:inset 4px 0 0 ", ";border-radius:0 8px 8px 0;padding:16px 24px;margin-top:8px;span{font-weight:400;font-size:14px;line-height:24px;}"], theme.colors.red_darker);
});
...
const Callout = ({
  ...
  return /*#__PURE__*/React.createElement(CalloutStyled, {
    className: className
...
const Form = ({
  ...
  const defaultLanguage = useSelector(selectDefaultLang);
...
export { Form, actions, reducer, sagas, selectors };
