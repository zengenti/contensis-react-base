import { a as cachedSearch, d as deliveryApi } from './ContensisDeliveryApi-DMHgybP6.js';
import { Query as Query$1 } from 'contensis-delivery-api';
import React from 'react';
import { Provider } from 'react-redux';
import { a as actions } from './slice-B3B4zFaZ.js';
import mapJson from 'jsonpath-mapper';
import { a7 as defaultExpressions, a8 as termExpressions, a9 as contentTypeIdExpression, aa as filterExpressions, ab as orderByExpression, ac as customWhereExpressions, ad as cloneDeep } from './sagas-Dtb-9WiJ.js';
import 'reselect';
import 'immer';
import 'deep-equal';
import 'deepmerge';
...
import { c as createLocaleRoutes, h as history, p as pickProject, r as rootSaga } from './App-C0tHnRFe.js';
export { A as ReactApp } from './App-C0tHnRFe.js';
import { c as createStore } from './store-DvfUmDcY.js';
import { s as setVersionStatus, c as setVersion } from './version-CG6KA6Mv.js';
...
import { H as HttpContext, m as mergeStaticRoutes } from './RouteLoader-yIkm-ygc.js';
...
import { S as SSRContextProvider } from './SSRContext-BbbB2Ksk.js';
      ...
      store.runSaga(rootSaga(withSagas)).toPromise().then(() => {
        ...
        try {
          ...
          const getContextHtml = (isFinal = false, styleTags, renderedJsxMarkup) => {
            ...
            // Getting style tags generated by "CSS Modules" because if we are not using styled-components
