...
import { G as GET_NODE_TREE, S as SET_NODE_TREE, a as GET_NODE_TREE_ERROR } from './store-BJneD4ut.js';
import { h as hasNavigationTree, a as injectRedux } from './version-CwSoLsiX.js';
...
import { f as findContentTypeMapping, h as handleRequiresLoginSaga, L as LoginHelper, c as getSearchOptions, g as getManagementApiClient, l as loginSagas } from './ChangePassword.container-Cks9jf1E.js';
import './sagas-D1Kfcr5S.js';
import 'reselect';
import 'immer';
import 'deep-equal';
import 'deepmerge';
import { h as routeParams } from './util-B6ELOcVX.js';
import 'contensis-core-api';
import { c as selectClientCredentials } from './selectors-DFyF199B.js';
import { a as RouteLoader } from './RouteLoader-msUj-h23.js';
import 'query-string';
...
function* ensureAccessTokenSaga(action) {
  ...
  if (config.releaseUri) {
    ...
    if (releaseError || !accessToken || !userLoggedIn) {
      ...
      LoginHelper.ClientRedirectToAccessDeniedPage((_action$location = action.location) === null || _action$location === void 0 ? void 0 : _action$location.pathname);
      return false;
    }
...
//# sourceMappingURL=App-y870HgE0.js.map
