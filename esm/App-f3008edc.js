...
import { a as setSurrogateKeys, S as SET_NAVIGATION_PATH, b as SET_ROUTE, U as UPDATE_LOADING_STATE, c as SET_ENTRY, d as SET_ANCESTORS, e as SET_SIBLINGS, f as setRoute } from './actions-5b76419a.js';
import { r as reduxStore, G as GET_NODE_TREE, h as hasNavigationTree, S as SET_NODE_TREE, b as GET_NODE_TREE_ERROR, i as injectRedux } from './version-c0e104cb.js';
import { s as selectVersionStatus } from './version-3671a3e0.js';
import { a as selectCurrentProject, s as selectRouteEntry, b as selectCurrentNode, c as selectCurrentAncestors, d as selectRouteEntryEntryId, e as selectRouteEntryLanguage, f as selectMappedEntry, q as queryParams, g as selectCurrentSearch } from './selectors-acde3a83.js';
import * as log from 'loglevel';
import { f as findContentTypeMapping, h as handleRequiresLoginSaga, l as loginSagas } from './login-952dac2a.js';
import 'query-string';
import { to } from 'await-to-js';
import { R as REGISTER_USER, a as REGISTER_USER_SUCCESS, b as REGISTER_USER_FAILED } from './reducers-42abcaf3.js';
import React from 'react';
import 'react-hot-loader';
import { R as RouteLoader } from './RouteLoader-0e7ca21d.js';
...
function* setRouteEntry(entry, node, ancestors, siblings, entryMapper, notFound = false, remapEntry = false) {
  ...
  const mappedEntry = currentEntryId === entrySys.id && currentEntryLang === entrySys.language && remapEntry === false ? (yield select(selectMappedEntry)) || {} : yield mapRouteEntry(entryMapper, { ...node,
    entry,
    ancestors,
    siblings
  });
...
//# sourceMappingURL=App-f3008edc.js.map
