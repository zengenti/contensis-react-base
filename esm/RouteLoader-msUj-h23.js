...
import { Z as selectRouteEntryContentTypeId, X as selectRouteEntry, a2 as selectRouteIsError, T as selectIsNotFound, a3 as selectRouteLoading, W as selectMappedEntry, O as selectCurrentProject, N as selectCurrentPath, a4 as selectRouteStatusCode, a1 as selectRouteErrorMessage, aa as setNavigationPath } from './selectors-2glWqc_z.js';
import { o as selectUserIsAuthenticated, l as selectUserGroups, m as matchUserGroup } from './selectors-DFyF199B.js';
import { a as useSSRContext, t as transformPathForSubsite } from './SSRContext-Z5VoJn4c.js';
...
const NotFound = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("header", null, /*#__PURE__*/React.createElement("h1", null, statusCode, " ", label), statusText && /*#__PURE__*/React.createElement("h2", {
    style: {
      background: '#eee',
      color: '#666',
      fontSize: '100%',
...
var RouteLoader = connect(mapStateToPropsMemoized, mapDispatchToProps)(toJS(RouteLoader$1));

export { HttpContext as H, NotFound as N, Redirect as R, Status as S, RouteLoader as a, mergeStaticRoutes as m, useHttpContext as u };
//# sourceMappingURL=RouteLoader-msUj-h23.js.map
