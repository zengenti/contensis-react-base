...
import { G as GET_NODE_TREE, b as SET_NODE_TREE, d as GET_NODE_TREE_ERROR } from './store-BvW6_C0H.js';
import { h as hasNavigationTree, b as injectRedux } from './version-DIHIOZQD.js';
...
import { a as cachedSearch } from './ContensisDeliveryApi-CqPcnP_R.js';
...
import './sagas-BkDEmmdV.js';
import 'reselect';
import 'immer';
import 'deep-equal';
import 'deepmerge';
import { r as routeParams } from './util-BuAZdfcq.js';
import 'contensis-core-api';
import { l as selectClientCredentials } from './matchGroups-DT-RunAc.js';
import { a as RouteLoader } from './RouteLoader-yDf3uwGr.js';
import 'query-string';
...
function* setLanguageRoute({
  ...
  if (payload !== null && payload !== void 0 && payload.redirect) {
    ...
    yield put(setRoute(payload.redirect + 'null'));
  }
}
...
//# sourceMappingURL=App-BbDLPLlH.js.map
