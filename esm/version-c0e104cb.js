...
import { h as SET_TARGET_PROJECT, i as SET_SURROGATE_KEYS, e as SET_SIBLINGS, b as SET_ROUTE, S as SET_NAVIGATION_PATH, U as UPDATE_LOADING_STATE, c as SET_ENTRY, d as SET_ANCESTORS, j as action } from './actions-5b76419a.js';
import { U as UserReducer } from './reducers-42abcaf3.js';
...
const hasNavigationTree = state => {
  ...
  return state === null || state === void 0 ? void 0 : (_state$navigation = state.navigation) === null || _state$navigation === void 0 ? void 0 : _state$navigation.isReady;
};
const selectNavigationRoot = state => {
  var _state$navigation2;

  return state === null || state === void 0 ? void 0 : (_state$navigation2 = state.navigation) === null || _state$navigation2 === void 0 ? void 0 : _state$navigation2.root;
};
const selectNavigationDepends = state => {
  var _state$navigation3;

  return state === null || state === void 0 ? void 0 : (_state$navigation3 = state.navigation) === null || _state$navigation3 === void 0 ? void 0 : _state$navigation3.treeDepends;
};
...
//# sourceMappingURL=version-c0e104cb.js.map
