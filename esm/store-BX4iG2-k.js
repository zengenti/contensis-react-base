...
import { S as SET_TARGET_PROJECT, v as SET_SURROGATE_KEYS, w as SET_SIBLINGS, x as SET_ROUTE, y as SET_NAVIGATION_PATH, z as UPDATE_LOADING_STATE, A as SET_ENTRY, B as SET_ANCESTORS, U as UserReducer } from './selectors-CAjGfIyu.js';
...
var createStore = async (featureReducers, initialState, history, stateType) => {
  ...
  if (stateType === 'immutable') {
    ...
    fromJS = (await import(/* webpackChunkName: "from-js" */'./fromJSLeaveImmer-DfnbPBKC.js')).default;
...
//# sourceMappingURL=store-BX4iG2-k.js.map
