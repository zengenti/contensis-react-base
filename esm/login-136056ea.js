...
<<<<<<< HEAD:esm/login-866fe64c.js
import { f as setRoute } from './actions-fda5e103.js';
import { L as LOGIN_USER, c as LOGOUT_USER, V as VALIDATE_USER, S as SET_AUTHENTICATION_STATE } from './reducers-b426d14a.js';
import { takeEvery, select, call, put } from '@redux-saga/core/effects';
import { q as queryParams, g as selectCurrentSearch } from './selectors-170581d2.js';
import { s as selectUserIsAuthenticated, a as selectUserGroups, m as matchUserGroup, b as selectClientCredentials } from './ToJs-19a3244a.js';
=======
import {
  f as findContentTypeMapping,
  g as setRoute,
} from './routing-3bbf9dde.js';
import {
  L as LOGIN_USER,
  n as LOGOUT_USER,
  V as VALIDATE_USER,
  S as SET_AUTHENTICATION_STATE,
} from './reducers-7c4796b0.js';
import {
  q as queryParams,
  g as selectCurrentSearch,
} from './routing-786c3bb0.js';
import { takeEvery, select, call, put } from '@redux-saga/core/effects';
import {
  a as selectUserIsAuthenticated,
  b as selectUserGroups,
  m as matchUserGroup,
  s as selectClientCredentials,
} from './ToJs-bf49708e.js';
import mapJson from 'jsonpath-mapper';
>>>>>>> contensis-14-forgot-change-password:esm/login-136056ea.js
...
const getManagementApiClient = async ({
  ...
  const client = Client.create({ ...config, projectId, rootUrl });
...
function* loginUserSaga(action = {}) {
  const { username, password, clientCredentials } = action; // If a WSFED_LOGIN site has dispatched the loginUser action
...
<<<<<<< HEAD:esm/login-866fe64c.js
export { LoginHelper as L, findContentTypeMapping as f, handleRequiresLoginSaga as h, loginSagas as l, refreshSecurityToken as r };
//# sourceMappingURL=login-866fe64c.js.map
=======
export {
  LoginHelper as L,
  getManagementApiClient as g,
  handleRequiresLoginSaga as h,
  loginSagas as l,
  refreshSecurityToken as r,
};
//# sourceMappingURL=login-2701d3cb.js.map
>>>>>>> contensis-14-forgot-change-password:esm/login-136056ea.js
