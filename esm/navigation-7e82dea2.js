...
import {
  i as SET_TARGET_PROJECT,
  j as SET_SURROGATE_KEYS,
  e as SET_SIBLINGS,
  b as SET_ROUTE,
    ...
    case SET_ENTRY: {
      ...
      if (!entry) {
        ...
        if (mappedEntry && Object.keys(mappedEntry).length > 0)
          nextState = nextState.set('mappedEntry', fromJS(mappedEntry)).set(
            'entry',
            fromJS({
              sys: entry.sys,
            })
...
export {
  ...
  SET_NODE_TREE as S,
  setVersion as a,
  GET_NODE_TREE_ERROR as b,
  createStore as c,
  version$1 as d,
  navigation$1 as e,
  hasNavigationTree as h,
  navigation as n,
  reduxStore as r,
  setVersionStatus as s,
  version as v,
};
