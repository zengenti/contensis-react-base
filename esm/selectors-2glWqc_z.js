...
const SET_API_METRICS = `${ROUTING_PREFIX}_SET_API_METRICS`;
...
const LIVE_ENTRY_NAVIGATE = `${LIVE_ENTRY_PREFIX}NAVIGATE`;
const LIVE_ENTRY_ROUTE_LOAD_OPTIONS = `${LIVE_ENTRY_PREFIX}ROUTE_LOAD_OPTIONS`;
const LIVE_ENTRY_RESET = `${LIVE_ENTRY_PREFIX}RESET`;
const LIVE_ENTRY_UPDATE = `${LIVE_ENTRY_PREFIX}UPDATE`;

var routing$2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  GET_ENTRY: GET_ENTRY,
  LIVE_ENTRY_NAVIGATE: LIVE_ENTRY_NAVIGATE,
  LIVE_ENTRY_PREFIX: LIVE_ENTRY_PREFIX,
  LIVE_ENTRY_RESET: LIVE_ENTRY_RESET,
  LIVE_ENTRY_ROUTE_LOAD_OPTIONS: LIVE_ENTRY_ROUTE_LOAD_OPTIONS,
  LIVE_ENTRY_UPDATE: LIVE_ENTRY_UPDATE,
  SET_ANCESTORS: SET_ANCESTORS,
  SET_API_METRICS: SET_API_METRICS,
  SET_ENTRY: SET_ENTRY,
...
const setNavigationPath = (path, contentPath, location, staticRoute, withEvents, statePath, routes, ssr) => action(SET_NAVIGATION_PATH, {
  path,
  contentPath,
  location,
  staticRoute,
 ...
 */
const setApiMetrics = metrics => action(SET_API_METRICS, metrics);

var routing$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  setApiMetrics: setApiMetrics,
...
function queryParams(search) {
  return parse(typeof window != 'undefined' ? window.location.search : search || '');
}
...
const selectSsrHostname = state => getImmutableOrJS(state, ['routing', 'ssrHostname']);
...
const selectRouteEntryAvailableLanguages = state => {
  const entry = selectRouteEntry(state);
  return getImmutableOrJS(entry, ['sys', 'availableLanguages'], []);
};
...
const selectQueryStringAsObject = createSelector([selectCurrentSearch], currentSearch => queryParams(currentSearch));
...
const selectCurrentNodeLanguage = state => getImmutableOrJS(state, ['routing', 'currentNode', 'language'], null);
...
const selectBreadcrumb = createSelector([selectCurrentAncestors, selectCurrentNode], (currentAncestors, currentNode) => [...currentAncestors, currentNode]);
...
var routing = /*#__PURE__*/Object.freeze({
  ...
  selectCurrentNodeLanguage: selectCurrentNodeLanguage,
  ...
  selectRouteEntryAvailableLanguages: selectRouteEntryAvailableLanguages,
  ...
  selectSsrHostname: selectSsrHostname,
  selectStaticRoute: selectStaticRoute,
  selectSurrogateKeys: selectSurrogateKeys
});

export { selectRouteEntryID as $, UserReducer as A, action as B, CHANGE_USER_PASSWORD as C, getImmutableOrJS as D, getJS as E, initialUserState as F, queryParams as G, routing$1 as H, routing as I, routing$2 as J, selectCurrentAncestors as K, LIVE_ENTRY_NAVIGATE as L, selectCurrentNode as M, selectCurrentPath as N, selectCurrentProject as O, selectCurrentSearch as P, selectCurrentSiblings as Q, REGISTER_USER as R, SET_ANCESTORS as S, selectIsNotFound as T, UPDATE_LOADING_STATE as U, VALIDATE_USER as V, selectMappedEntry as W, selectRouteEntry as X, selectRouteEntryAvailableLanguages as Y, selectRouteEntryContentTypeId as Z, selectRouteEntryEntryId as _, CHANGE_USER_PASSWORD_ERROR as a, selectRouteEntryLanguage as a0, selectRouteErrorMessage as a1, selectRouteIsError as a2, selectRouteLoading as a3, selectRouteStatusCode as a4, selectSsrApiCalls as a5, selectStaticRoute as a6, selectSurrogateKeys as a7, setApiMetrics as a8, setCurrentProject as a9, setNavigationPath as aa, setRoute as ab, types as ac, CHANGE_USER_PASSWORD_SENDING as b, CHANGE_USER_PASSWORD_SUCCESS as c, LIVE_ENTRY_PREFIX as d, LIVE_ENTRY_RESET as e, LIVE_ENTRY_ROUTE_LOAD_OPTIONS as f, LIVE_ENTRY_UPDATE as g, LOGIN_USER as h, LOGOUT_USER as i, REGISTER_USER_FAILED as j, REGISTER_USER_SUCCESS as k, REQUEST_USER_PASSWORD_RESET as l, REQUEST_USER_PASSWORD_RESET_ERROR as m, REQUEST_USER_PASSWORD_RESET_SENDING as n, REQUEST_USER_PASSWORD_RESET_SUCCESS as o, RESET_USER_PASSWORD as p, RESET_USER_PASSWORD_ERROR as q, RESET_USER_PASSWORD_SENDING as r, RESET_USER_PASSWORD_SUCCESS as s, SET_API_METRICS as t, SET_AUTHENTICATION_STATE as u, SET_ENTRY as v, SET_NAVIGATION_PATH as w, SET_ROUTE as x, SET_SIBLINGS as y, SET_TARGET_PROJECT as z };
//# sourceMappingURL=selectors-2glWqc_z.js.map
