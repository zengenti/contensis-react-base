...
function* watchLivePreviewSaga(context) {
  ...
  (_ref = parent || opener) === null || _ref === void 0 || _ref.postMessage(routeLoadOptions, '*');
  try {
    while (true) {
...
export { AppRoot as A, browserHistory as b, createLocaleRoutes as c, history as h, logError as l, pickProject as p, rootSaga as r, shorten as s };
//# sourceMappingURL=App-XsPRkJNg.js.map
