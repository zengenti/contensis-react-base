...
export declare const selectClientCredentials: (state: AppState) => any;
export declare const selectUser: (state: AppState) => any;
...
export declare const selectUserGroups: (state: AppState) => any;
export declare const selectUserSecurityToken: (state: AppState) => any;
export declare const selectUserRegistration: (state: AppState) => any;
