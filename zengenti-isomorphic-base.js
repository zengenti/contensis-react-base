(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("immutable"), require("contensis-delivery-api"), require("react"), require("prop-types"), require("query-string"), require("react-redux"), require("react-router-dom"), require("@redux-saga/core/effects"), require("js-cookie"), require("react-router-config"), require("react-hot-loader"), require("redux"), require("redux-saga"), require("redux-immutable"), require("redux-thunk"), require("loglevel"), require("react-loadable"), require("history"), require("react-dom/server"), require("minify-css-string"), require("isomorphic-fetch"), require("express"), require("evil-dns"), require("react-loadable/webpack"), require("react-helmet"), require("serialize-javascript"), require("http-proxy"), require("styled-components"), require("fromentries"), require("xxhashjs"));
	else if(typeof define === 'function' && define.amd)
		define(["immutable", "contensis-delivery-api", "react", "prop-types", "query-string", "react-redux", "react-router-dom", "@redux-saga/core/effects", "js-cookie", "react-router-config", "react-hot-loader", "redux", "redux-saga", "redux-immutable", "redux-thunk", "loglevel", "react-loadable", "history", "react-dom/server", "minify-css-string", "isomorphic-fetch", "express", "evil-dns", "react-loadable/webpack", "react-helmet", "serialize-javascript", "http-proxy", "styled-components", "fromentries", "xxhashjs"], factory);
	else {
...
const webApp = (app, ReactApp, config) => {
  ...
  app.get('/*', (request, response, next) => {
    ...
    const versionStatusFromHostname = ContensisDeliveryApi["deliveryApi"].getVersionStatusFromHostname(request.hostname);
