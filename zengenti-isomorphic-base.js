(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("immutable"), require("react"), require("contensis-delivery-api"), require("prop-types"), require("query-string"), require("react-redux"), require("react-router-dom"), require("react-router-config"), require("react-hot-loader"), require("@redux-saga/core/effects"), require("js-cookie"), require("redux"), require("loglevel"), require("react-loadable"), require("history"), require("redux-saga"), require("redux-immutable"), require("redux-thunk"), require("react-dom/server"), require("minify-css-string"), require("isomorphic-fetch"), require("express"), require("evil-dns"), require("react-loadable/webpack"), require("react-helmet"), require("serialize-javascript"), require("http-proxy"), require("styled-components"), require("fromentries"), require("xxhashjs"));
	else if(typeof define === 'function' && define.amd)
		define(["immutable", "react", "contensis-delivery-api", "prop-types", "query-string", "react-redux", "react-router-dom", "react-router-config", "react-hot-loader", "@redux-saga/core/effects", "js-cookie", "redux", "loglevel", "react-loadable", "history", "redux-saga", "redux-immutable", "redux-thunk", "react-dom/server", "minify-css-string", "isomorphic-fetch", "express", "evil-dns", "react-loadable/webpack", "react-helmet", "serialize-javascript", "http-proxy", "styled-components", "fromentries", "xxhashjs"], factory);
	else {
...
var external_react_router_config_ = __webpack_require__(24);
