(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("immutable"), require("contensis-delivery-api"), require("react"), require("query-string"), require("react-redux"), require("@redux-saga/core/effects"), require("js-cookie"), require("redux"), require("jsonpath-mapper"), require("redux-saga"), require("redux-immutable"), require("redux-thunk"));
	else if(typeof define === 'function' && define.amd)
		define(["immutable", "contensis-delivery-api", "react", "query-string", "react-redux", "@redux-saga/core/effects", "js-cookie", "redux", "jsonpath-mapper", "redux-saga", "redux-immutable", "redux-thunk"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("immutable"), require("contensis-delivery-api"), require("react"), require("query-string"), require("react-redux"), require("@redux-saga/core/effects"), require("js-cookie"), require("redux"), require("jsonpath-mapper"), require("redux-saga"), require("redux-immutable"), require("redux-thunk")) : factory(root["immutable"], root["contensis-delivery-api"], root["react"], root["query-string"], root["react-redux"], root["@redux-saga/core/effects"], root["js-cookie"], root["redux"], root["jsonpath-mapper"], root["redux-saga"], root["redux-immutable"], root["redux-thunk"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(global, function(__WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__5__, __WEBPACK_EXTERNAL_MODULE__7__, __WEBPACK_EXTERNAL_MODULE__12__, __WEBPACK_EXTERNAL_MODULE__16__, __WEBPACK_EXTERNAL_MODULE__24__, __WEBPACK_EXTERNAL_MODULE__25__, __WEBPACK_EXTERNAL_MODULE__28__, __WEBPACK_EXTERNAL_MODULE__32__, __WEBPACK_EXTERNAL_MODULE__33__, __WEBPACK_EXTERNAL_MODULE__36__, __WEBPACK_EXTERNAL_MODULE__37__) {
...
exports.urls = __webpack_require__(75); // Delivery API functions

const contensisDeliveryApi = __webpack_require__(13);

exports.cachedSearch = contensisDeliveryApi.cachedSearch;
exports.deliveryApi = contensisDeliveryApi.deliveryApi; // JSON mapping functions

exports.jpath = __webpack_require__(35).jpath;
exports.mapJson = __webpack_require__(35).mapJson;
exports.mapEntries = __webpack_require__(35).mapEntries;
exports.mapComposer = __webpack_require__(35).mapComposer; // JSON mapping hooks

exports.useMapper = __webpack_require__(35).useMapper;
exports.useEntriesMapper = __webpack_require__(35).useEntriesMapper;
exports.useEntryMapper = __webpack_require__(35).useEntryMapper;
exports.useComposerMapper = __webpack_require__(35).useComposerMapper;
