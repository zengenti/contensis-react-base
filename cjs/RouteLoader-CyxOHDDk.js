...
var SSRContext = require('./SSRContext-D-6IbwgW.js');
...
const NotFound = ({
  ...
  var _STATUS_TEXT$statusCo;
  const label = (_STATUS_TEXT$statusCo = STATUS_TEXT[statusCode]) != null ? _STATUS_TEXT$statusCo : STATUS_TEXT[404];
  return /*#__PURE__*/React__default.default.createElement(React__default.default.Fragment, null, /*#__PURE__*/React__default.default.createElement("header", null, /*#__PURE__*/React__default.default.createElement("h1", null, statusCode, " ", label), statusText && /*#__PURE__*/React__default.default.createElement("h2", {
    style: {
      background: '#eee',
      color: '#666',
      fontSize: '100%',
...
const RouteLoader = ({
  ...
  if (isStaticRoute && !(!isLoggedIn && routeRequiresLogin)) {
    if (selectors$1.matchUserGroup(userGroups, routeRequiresLogin)) return /*#__PURE__*/React__default.default.createElement(StaticRouteLoader, {
  ...
  if (contentTypeId && !(!isLoggedIn && routeRequiresLogin)) {
    ...
    if (MatchedComponent && !(MatchedComponent.requireLogin && !isLoggedIn)) {
      if (selectors$1.matchUserGroup(userGroups, MatchedComponent.requireLogin)) return /*#__PURE__*/React__default.default.createElement(MatchedComponent.component, {
        projectId: projectId,
...
const mapStateToPropsMemoized = reselect.createSelector(selectors.selectRouteEntryContentTypeId, selectors.selectRouteEntry, selectors.selectRouteIsError, selectors.selectIsNotFound, selectors.selectRouteLoading, selectors$1.selectUserIsAuthenticated, selectors.selectMappedEntry, selectors.selectCurrentProject, selectors.selectCurrentPath, selectors.selectRouteStatusCode, selectors.selectRouteErrorMessage, selectors$1.selectUserGroups, (contentTypeId, entry, isError, isNotFound, isLoading, isLoggedIn, mappedEntry, projectId, statePath, statusCode, statusText, userGroups) => ({
  contentTypeId,
  entry,
  isError,
  isNotFound,
...
//# sourceMappingURL=RouteLoader-CyxOHDDk.js.map
