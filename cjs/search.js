...
const termExpressions = (searchTerm, weightedSearchFields) => {
  if (searchTerm && weightedSearchFields && weightedSearchFields.length > 0) {
    ...
    return [contensisDeliveryApi.Op.freeText(Fields.searchContent, searchTerm), contensisDeliveryApi.Op.or().addRange(operators)];
  } else if (searchTerm) {
    return [contensisDeliveryApi.Op.freeText(Fields.searchContent, searchTerm), contensisDeliveryApi.Op.contains(Fields.wildcard, searchTerm)];
  } else {
    return [];
  }
};
