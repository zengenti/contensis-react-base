...
var ContensisDeliveryApi = require('./ContensisDeliveryApi-caJB2NLX.js');
var contensisDeliveryApi = require('contensis-delivery-api');
var util = require('./util-Bv-JT9Fd.js');
var selectors$1 = require('./selectors-DAQR0uZa.js');
require('./slice-DxcXAngA.js');
var mapJson = require('jsonpath-mapper');
var contensisCoreApi = require('contensis-core-api');
var merge = require('deepmerge');
var queryString = require('query-string');
var selectors$2 = require('./selectors-C1CqEUmL.js');
...
const getLocalisedCurrent = (state, language = selectors$1.selectCurrentLanguage(state), context = getSearchContext(state)) => {
  var _facet$i18n;
...
//# sourceMappingURL=sagas-C7-JPorZ.js.map
