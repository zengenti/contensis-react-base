...
var util = require('./util-B88a6CU7.js');
...
const searchUriTemplate = {
  path: ({
    ...
    const currentPath = selectors$1.selectCurrentPath(state) || '/search';
    if (context !== 'listings') {
...
const queryParamsTemplate = {
  ...
  projectId: ({
    ...
    var _getFacet;
    return ((_getFacet = getFacet$1(state, facet, context, 'js')) === null || _getFacet === void 0 ? void 0 : _getFacet.projectId) || selectors$1.selectCurrentProject(state);
  },
...
const runSearch = (action, state, queryParams) => {
  ...
  if (context === Context.facets && isSSR ||
...
//# sourceMappingURL=sagas-C7IjEAVx.js.map
