...
LoginHelper.IS_TWO_FA = TWO_FACTOR_AUTH;
...
const loginSagas = [effects.takeEvery(reducers.LOGIN_USER, loginUserSaga), effects.takeEvery(reducers.VERIFY_TWO_FA_TOKEN, verifyTwoFaTokenSaga), effects.takeEvery(reducers.LOGOUT_USER, logoutUserSaga), effects.takeEvery(reducers.VALIDATE_USER, validateUserSaga), effects.takeEvery(reducers.SET_AUTHENTICATION_STATE, redirectAfterSuccessfulLoginSaga)];
...
//# sourceMappingURL=login-888ea612.js.map
