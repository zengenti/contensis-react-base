...
var ChangePassword_container = require('./ChangePassword.container-DrO8p-7S.js');
...
function* getRouteSaga(action) {
  let entry = null;
  try {
    var _staticRoute$route, _staticRoute$route2, _staticRoute$route3, _appsays, _appsays2, _appsays3, _pathNode2, _pathNode3;
    const {
      withEvents,
      routes: {
        ContentTypeMappings = {}
    ...
    const staticRouteLinkDepth = staticRoute === null || staticRoute === void 0 || (_staticRoute$route = staticRoute.route) === null || _staticRoute$route === void 0 || (_staticRoute$route = _staticRoute$route.params) === null || _staticRoute$route === void 0 ? void 0 : _staticRoute$route.linkDepth;
    const staticRouteFields = staticRoute === null || staticRoute === void 0 || (_staticRoute$route2 = staticRoute.route) === null || _staticRoute$route2 === void 0 || (_staticRoute$route2 = _staticRoute$route2.params) === null || _staticRoute$route2 === void 0 ? void 0 : _staticRoute$route2.fields;
    const staticRouteFieldLinkDepths = staticRoute === null || staticRoute === void 0 || (_staticRoute$route3 = staticRoute.route) === null || _staticRoute$route3 === void 0 || (_staticRoute$route3 = _staticRoute$route3.params) === null || _staticRoute$route3 === void 0 ? void 0 : _staticRoute$route3.fieldLinkDepths;
    ...
    if (!isPreview && ((_appsays2 = appsays) !== null && _appsays2 !== void 0 && _appsays2.customRouting || staticRoute && !staticRoute.route.fetchNode || routeEntry && action.statePath === action.path && ((_appsays3 = appsays) === null || _appsays3 === void 0 ? void 0 : _appsays3.refetchNode) !== true)) {
      ...
      if (isPreview) {
        ...
        if (setContentTypeLimits && (_pathNode = pathNode) !== null && _pathNode !== void 0 && (_pathNode = _pathNode.entry) !== null && _pathNode !== void 0 && (_pathNode = _pathNode.sys) !== null && _pathNode !== void 0 && _pathNode.id) {
          var _payload$items;
    ...
    const resolvedContentTypeMapping = ChangePassword_container.findContentTypeMapping(ContentTypeMappings, (_pathNode2 = pathNode) === null || _pathNode2 === void 0 || (_pathNode2 = _pathNode2.entry) === null || _pathNode2 === void 0 || (_pathNode2 = _pathNode2.sys) === null || _pathNode2 === void 0 ? void 0 : _pathNode2.contentTypeId) || {};
    ...
    if ((_pathNode3 = pathNode) !== null && _pathNode3 !== void 0 && (_pathNode3 = _pathNode3.entry) !== null && _pathNode3 !== void 0 && (_pathNode3 = _pathNode3.sys) !== null && _pathNode3 !== void 0 && _pathNode3.id) {
      var _staticRoute$route5, _appsays4;
      entry = pathNode.entry;
      yield effects.call(setRouteEntry, currentPath, entry, pathNode, ancestors, siblings, (staticRoute === null || staticRoute === void 0 || (_staticRoute$route5 = staticRoute.route) === null || _staticRoute$route5 === void 0 || (_staticRoute$route5 = _staticRoute$route5.fetchNode) === null || _staticRoute$route5 === void 0 ? void 0 : _staticRoute$route5.entryMapper) || resolvedContentTypeMapping.entryMapper, false, (_appsays4 = appsays) === null || _appsays4 === void 0 ? void 0 : _appsays4.refetchNode);
    } else {
...
//# sourceMappingURL=App-D2_FqsUD.js.map
