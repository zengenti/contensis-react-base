...
var version = require('./version-deb4db7b.js');
var actions = require('./actions-087cf141.js');
var reducers = require('./reducers-fde41d6b.js');
var history$1 = require('history');
var effects = require('@redux-saga/core/effects');
var contensisDeliveryApi = require('contensis-delivery-api');
var selectors = require('./selectors-5ee89c82.js');
var version$1 = require('./version-c8efef81.js');
...
var RouteLoader = require('./RouteLoader-2207ada8.js');
...
function* setRouteEntry(entry, node, ancestors, siblings, entryMapper, notFound = false, remapEntry = false) {
  ...
  const mappedEntry = currentEntryId === entrySys.id && currentEntryLang === entrySys.language && remapEntry === false ? (yield effects.select(selectors.selectMappedEntry)) || {} : yield mapRouteEntry(entryMapper, { ...node,
    entry,
    ancestors,
    siblings
  });
...
//# sourceMappingURL=App-81347690.js.map
