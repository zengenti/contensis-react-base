...
const selectQueryStringAsObject = reselect.createSelector([selectCurrentSearch], currentSearch => queryParams(currentSearch));
...
const selectBreadcrumb = reselect.createSelector([selectCurrentAncestors, selectCurrentNode], (currentAncestors, currentNode) => [...currentAncestors, currentNode]);
...
exports.LIVE_ENTRY_NAVIGATE = LIVE_ENTRY_NAVIGATE;
exports.LIVE_ENTRY_PREFIX = LIVE_ENTRY_PREFIX;
exports.LIVE_ENTRY_RESET = LIVE_ENTRY_RESET;
exports.LIVE_ENTRY_ROUTE_LOAD_OPTIONS = LIVE_ENTRY_ROUTE_LOAD_OPTIONS;
exports.LIVE_ENTRY_UPDATE = LIVE_ENTRY_UPDATE;
...
exports.SET_API_METRICS = SET_API_METRICS;
...
exports.selectRouteEntryAvailableLanguages = selectRouteEntryAvailableLanguages;
