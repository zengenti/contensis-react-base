...
var version = require('./version-DBVUgqWk.js');
...
var selectors$2 = require('./selectors-PS7proOd.js');
...
const termExpressions = (searchTerm, weightedSearchFields, fuzzySearch, omitSearchFields = []) => {
  if (searchTerm && weightedSearchFields && weightedSearchFields.length > 0) {
    ...
    const freeTextOp = (f, term) => {
      var _f$fuzzySearch;
      return fieldExpression(f.fieldId, util.fixFreeTextForElastic(term), 'freeText', f.weight, (_f$fuzzySearch = f.fuzzySearch) != null ? _f$fuzzySearch : fuzzySearch);
    };
...
//# sourceMappingURL=sagas-DOJJCnqw.js.map
