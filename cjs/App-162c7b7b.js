...
function* setRouteEntry(entry, node, ancestors, siblings, entryMapper, notFound = false) {
  ...
  const mappedEntry = currentEntryId === entrySys.id && currentEntryLang === entrySys.language ? ((yield effects.select(selectors.selectMappedEntry)) || immutable.Map()).toJS() : yield mapRouteEntry(entryMapper, { ...node,
    entry,
    ancestors,
    siblings
  });
...
//# sourceMappingURL=App-162c7b7b.js.map
