...
var store = require('./store-CIQr9zw1.js');
var version = require('./version-BK65lgrJ.js');
var to = require('await-to-js');
var createSagaMiddleware = require('redux-saga');
var contensisDeliveryApi = require('contensis-delivery-api');
var slice = require('./slice-5xJMH24n.js');
var selectors$1 = require('./selectors-DqF-H3Cl.js');
var version$1 = require('./version-1OIjCXtN.js');
var ContensisDeliveryApi = require('./ContensisDeliveryApi-BK6iYSHZ.js');
var React = require('react');
require('react-cookie');
require('react-redux');
require('./VersionInfo-D0QNB4s2.js');
require('react-helmet-async');
require('jsonpath-mapper');
require('react-router-dom');
var selectors = require('./selectors-DAQR0uZa.js');
var ChangePassword_container = require('./ChangePassword.container-CHLeux4z.js');
require('./sagas-MpIAwV4E.js');
require('reselect');
require('immer');
require('deep-equal');
require('deepmerge');
var util = require('./util-DrSUt_Ve.js');
require('contensis-core-api');
var selectors$2 = require('./selectors-CZBdS7Ih.js');
var RouteLoader = require('./RouteLoader-UXGDnci_.js');
...
function* ensureAccessTokenSaga(action) {
  ...
  if (ContensisDeliveryApi.isSSR) return true;
  ...
  if (config.releaseUri) {
    ...
    if (releaseError || !accessToken || !userLoggedIn) {
      ...
      ChangePassword_container.LoginHelper.ClientRedirectToAccessDeniedPage((_action$location = action.location) === null || _action$location === void 0 ? void 0 : _action$location.pathname);
      return false;
    }
...
//# sourceMappingURL=App-B4ZfjxSS.js.map
