...
var RouteLoader = require('./RouteLoader-6458943a.js');
...
let initialState = require$$0.Map({
  ...
  entryID: null,
  entry: null,
  entryDepends: new require$$0.List(),
  contentTypeId: null,
    ...
    case routing.SET_ENTRY:
      {
        ...
        if (!entry) {
          ...
          nextState = state.set('entryID', action.id).set('entryDepends', require$$0.fromJS(entryDepends)).set('entry', require$$0.fromJS(entry)).set('isLoading', isLoading);
        }
...
//# sourceMappingURL=App-aa8401f6.js.map
